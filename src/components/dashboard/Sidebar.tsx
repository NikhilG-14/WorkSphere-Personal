...
export const Sidebar = ({
  ...
  const sidebarItems = [
    ...
    { 
      ...
      route: userRole === "client" ? `/manage-jobs?role=${userRole}` : `/jobs?role=${userRole}`
    },
    { 
      id: "proposals", 
      label: "Proposals", 
    ...
    { 
      ...
      icon: Upload,
      badge: null,
      route: `/submissions?role=${userRole}`
    },
    { 
      id: "disputes", 
      label: "Disputes", 
