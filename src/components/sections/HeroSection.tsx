    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-12">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center">
        <div className="w-[450px] h-[450px] sm:w-[600px] sm:h-[600px] lg:w-[700px] lg:h-[700px] relative">
          <iframe
            src="https://my.spline.design/holographicearthwithdynamiclines-0qgZGFl1oF7nDFMFloWC5u16/"
            frameBorder="0"
            width="100%"
            height="100%"
            className="absolute inset-0 rounded-lg opacity-30"
            title="Interactive 3D planet visualization"
            aria-label="3D animated planet model showcasing the Web3 freelancing platform"
            loading="lazy"
          />
        </div>
      </div>
