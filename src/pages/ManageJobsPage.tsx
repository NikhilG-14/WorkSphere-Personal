  ...
  const proposals = [
    {
      ...
      bid: 4500,
      duration: "2 weeks",
      coverLetter: "I have 5+ years of experience in Solidity development and have audited over 50 smart contracts...",
      status: "shortlisted"
    },
    {
      id: "2",
      ...
      bid: 5200,
      duration: "10 days",
      coverLetter: "As a certified blockchain security expert, I specialize in DeFi protocol audits...",
      status: "shortlisted"
    },
    {
      id: "3",
      ...
      bid: 4800,
      duration: "2 weeks",
      coverLetter: "With extensive experience in gas optimization and security audits, I can deliver...",
      status: "pending"
    }
  ];
  ...
  return (
    <div className="min-h-screen p-6 lg:p-8">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-neon-purple/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-neon-gold">${job.budget}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-foreground-muted">Proposals</span>
                    <span className="font-semibold text-foreground">{job.proposals}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-foreground-muted">Posted</span>
                    <span className="text-foreground-muted">{job.postedDate}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-2 mt-4">
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/jobs/${job.id}?role=${userRole}`);
                    }}
                  >
            ...
            <Button
              variant="neon"
              className="w-full"
              onClick={() => navigate(`/jobs/post?role=${userRole}`)}
            >
              Post New Job
            </Button>
          </div>
                ...
                {proposals.map((proposal, index) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="glass-panel p-4 rounded-lg">
                        <div className="flex items-center gap-2 text-neon-gold mb-1">
                          ...
                          <span className="text-sm text-foreground-muted">Bid Amount</span>
                        </div>
                        <p className="text-xl font-bold text-foreground">${proposal.bid}</p>
                      </div>
                      <div className="glass-panel p-4 rounded-lg">
                        ...
                        <p className="text-xl font-bold text-foreground">{proposal.duration}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button variant="glass" className="gap-2 text-destructive hover:text-destructive">
